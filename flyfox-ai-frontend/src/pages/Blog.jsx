  ...
  return (
    <div className="bg-gray-100 min-h-screen font-sans">
      <header className="bg-[#003366] text-white p-5 text-center">
        <h1 className="text-3xl font-bold">FLYFOX AI Blog</h1>
      </header>
      ...
      <main className="max-w-6xl mx-auto p-5 bg-white rounded-lg my-5 grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div className="bg-gray-50 p-4 rounded shadow hover:shadow-lg" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h2 className="text-[#003366] text-2xl font-bold mb-2 flex items-center"><BookOpen className="mr-2" /> Quantum Computing Horizons</h2>
          <p className="text-gray-600 mb-2">Posted on October 1, 2023</p>
          <p>Delving into recent developments in neuromorphic quantum systems.</p>
        </motion.div>
        <motion.div className="bg-gray-50 p-4 rounded shadow hover:shadow-lg" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
          <h2 className="text-[#003366] text-2xl font-bold mb-2 flex items-center"><Cpu className="mr-2" /> Transforming AI with FLYFOX SDK</h2>
          <p className="text-gray-600 mb-2">Posted on September 15, 2023</p>
          <p>Analysis of quantum-enhanced machine learning acceleration.</p>
        </motion.div>
