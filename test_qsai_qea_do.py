...
class QSAIQEA_DOTester:
    ...
    async def _test_qsai_engine(self):
        ...
        try:
            ...
            from src.nqba_stack.qsai_engine import QSAIEngine, ContextVector, DecisionState
            ...
            self._record_test_result("QSAI Engine", "PASSED", "All QSAI tests completed successfully")
    ...
    async def _test_agent_registration(self, qsai, ltc_logger):
        ...
        await qsai.agent_manager.register_agent("offer_001", AgentType.OFFER, offer_agent)
        await qsai.agent_manager.register_agent("timing_001", AgentType.TIMING, timing_agent)
        await qsai.agent_manager.register_agent("channel_001", AgentType.CHANNEL, channel_agent)
    ...
    async def _test_decision_pipeline(self, qsai):
        ...
        if decision:
            ...
            logger.warning("    ⚠️ No decision generated (this may be expected in some cases)")
    ...
    async def _test_safety_arbitration(self, qsai):
        ...
        # Validate action
        is_valid, violations, status = await qsai.safety_arbiter.validate_action(test_proposal, test_context)
    ...
    async def _test_qea_do_system(self):
        ...
        try:
            ...
            self._record_test_result("QEA-DO System", "PASSED", "All QEA-DO tests completed successfully")
    ...
    async def _test_algorithm_generation(self, qea_do):
        ...
        if artifact:
            ...
            logger.info(f"    ✅ Algorithm type: {artifact.blueprint.algorithm_type.value}")
            logger.info(f"    ✅ Estimated reward: {artifact.blueprint.estimated_reward}")
            ...
            logger.warning("    ⚠️ No algorithm generated (this may be expected in some cases)")
    ...
    async def _test_verification_pipeline(self, qea_do):
        ...
        from src.nqba_stack.qea_do import AlgorithmArtifact, AlgorithmBlueprint, QUBOSolution, AlgorithmType
        import numpy as np
        ...
        logger.info(f"    ✅ Verification completed: {verification_report.status.value}")
    ...
    async def _test_integration(self):
        ...
        try:
            ...
            self._record_test_result("Integration", "PASSED", "All integration tests completed successfully")
    ...
    async def _test_performance(self):
        ...
        try:
            ...
            self._record_test_result("Performance", "PASSED", "All performance tests completed successfully")
    ...
    async def _generate_test_report(self):
        ...
        if failed_tests > 0:
            ...
            logger.info("🎉 All tests passed! QSAI and QEA-DO systems are working correctly.")
