...
async def demo_revenue_projections(flyfox_ai: FLYFOXAIPod):
    ...
    revenue_projections = {
        "Year 1": {
            "subscription": {"customers": 500, "avg_revenue": "$2,000/mo", "total": "$12M"},
            "usage_based": {"customers": 500, "avg_revenue": "$500/mo", "total": "$3M"},
            "licensing": {"customers": 100, "avg_revenue": "$50,000", "total": "$5M"},
            "success_fees": {"customers": 200, "avg_revenue": "$2,000/mo", "total": "$4.8M"},
            "white_label": {"customers": 50, "avg_revenue": "$10,000/mo", "total": "$6M"},
            "marketplace": {"customers": 1000, "avg_revenue": "$200/mo", "total": "$2.4M"},
            "total": "$33.2M"
        },
        "Year 3": {
            "subscription": {"customers": 2000, "avg_revenue": "$3,000/mo", "total": "$72M"},
            "usage_based": {"customers": 2000, "avg_revenue": "$1,000/mo", "total": "$24M"},
            "licensing": {"customers": 500, "avg_revenue": "$100,000", "total": "$50M"},
            "success_fees": {"customers": 1000, "avg_revenue": "$5,000/mo", "total": "$60M"},
            "white_label": {"customers": 200, "avg_revenue": "$25,000/mo", "total": "$60M"},
            "marketplace": {"customers": 5000, "avg_revenue": "$500/mo", "total": "$30M"},
            "total": "$296M"
        },
        "Year 5": {
            "subscription": {"customers": 5000, "avg_revenue": "$4,000/mo", "total": "$240M"},
            "usage_based": {"customers": 5000, "avg_revenue": "$2,000/mo", "total": "$120M"},
            "licensing": {"customers": 1000, "avg_revenue": "$200,000", "total": "$200M"},
            "success_fees": {"customers": 2500, "avg_revenue": "$10,000/mo", "total": "$300M"},
            "white_label": {"customers": 500, "avg_revenue": "$50,000/mo", "total": "$300M"},
            "marketplace": {"customers": 10000, "avg_revenue": "$1,000/mo", "total": "$120M"},
            "total": "$1.28B"
        }
    }
    ...
    for year, projections in revenue_projections.items():
        ...
        print(f"   {'Revenue Stream':<20} {'Customers':<12} {'Avg Revenue':<15} {'Total Revenue':<15}")
        print(f"   {'-'*20} {'-'*12} {'-'*15} {'-'*15}")
        
        for stream, data in projections.items():
            if stream != "total":
                print(f"   {stream:<20} {data['customers']:<12} {data['avg_revenue']:<15} {data['total']:<15}")
