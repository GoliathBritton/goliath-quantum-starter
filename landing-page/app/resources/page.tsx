        ...
        <div className="container-quantum text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <LinkComponent href="#documentation" className="btn-secondary">
              ...
              >
                ...
                <div className="flex items-center space-x-3 mb-4">
                  <div className="w-12 h-12 bg-brand-cyan rounded-lg flex items-center justify-center">
                    {React.createElement(resource.icon, { className: "h-6 w-6 text-white" }) as JSX.Element}
                  </div>
                  <div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    {React.createElement(resource.icon, { className: "h-5 w-5 text-brand-cyan" }) as JSX.Element}
            ...
            {[
              ...
              >
                <div className="w-16 h-16 bg-brand-cyan rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-200">
                  {React.createElement(item.icon, { className: "h-8 w-8 text-white" }) as JSX.Element}
                </div>
