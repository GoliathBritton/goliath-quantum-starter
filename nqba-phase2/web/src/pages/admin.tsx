...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    if (!adminToken || adminRole !== 'master-admin') {
      router.push('/login');
      return;
    }
  ...
  const handlePlatformAction = (action: string) => {
    ...
    alert(`Platform action: ${action} - This would execute in production`);
  };
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                NQBA Platform Administration & Control Center
              </p>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{stats.platformHealth}</dd>
                  </dl>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Platform Management</h3>
              <div className="space-y-3">
                <button
                  onClick={() => handlePlatformAction('restart')}
                ...
                <button
                  onClick={() => handlePlatformAction('update')}
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Check for Updates
                </button>
                <button
                  onClick={() => handlePlatformAction('logs')}
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  View System Logs
                </button>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => handlePlatformAction('users')}
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Manage Users
                </button>
                <button
                  onClick={() => handlePlatformAction('subscriptions')}
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  View Subscriptions
                </button>
                <button
                  onClick={() => handlePlatformAction('billing')}
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Billing Overview
                </button>
