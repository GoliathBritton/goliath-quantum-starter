...
class QuantumOptimizerPod(AgentInterface):
    ...
    def run(self, variables: int, Q: list, constraints: list = None, objective: str = "maximize"):
        ...
        ltc = ltc_record(
            ...
            outputs={"assignment": result["assignment"], "objective_value": result["objective_value"]},
