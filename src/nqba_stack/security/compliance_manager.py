...
class ComplianceManager:
    ...
    def _initialize_data_flows(self):
        ...
        flows = [
            DataFlow(
                ...
                data_categories=["personal_identifiers", "contact_information", "business_information"],
                purposes=[DataProcessingPurpose.SERVICE_PROVISION, DataProcessingPurpose.COMPLIANCE],
            ...
            DataFlow(
                ...
                data_categories=["contact_information", "preferences", "interaction_history"],
                purposes=[DataProcessingPurpose.MARKETING, DataProcessingPurpose.ANALYTICS],
        ...
        compliance_items = [
            SFGCompliance(
                ...
                state_requirements={
                    ...
                    "NY": ["Insurance license", "Financial statements", "Character references"],
            ...
            SFGCompliance(
                ...
                state_requirements={
                    "CA": ["Fee disclosure", "Conflict of interest", "Compensation structure"],
                    "NY": ["Fee disclosure", "Material relationships", "Regulatory status"],
                    "TX": ["Fee disclosure", "Business relationships", "Regulatory compliance"]
                },
                documentation_required=[
                    "Disclosure forms",
                    "Client agreements",
            ...
            SFGCompliance(
                ...
                state_requirements={
                    "CA": ["CCPA compliance", "Data security measures", "Breach notification"],
                    "NY": ["NYDFS cybersecurity", "Data protection", "Incident response"],
                    "TX": ["Data breach notification", "Security measures", "Privacy policies"]
                },
                documentation_required=[
                    "Privacy policies",
    ...
    def assess_soc2_control(self, control_id: str, assessment_data: Dict[str, Any]) -> bool:
    ...
    def get_soc2_status(self) -> Dict[str, Any]:
        ...
        implemented_controls = sum(1 for control in self.soc2_controls.values() if control.is_implemented)
        pending_assessments = sum(1 for control in self.soc2_controls.values() 
        ...
        return {
            ...
            "next_assessment": min([c.next_assessment for c in self.soc2_controls.values() if c.next_assessment], default=None)
        }
    ...
    def get_gdpr_ccpa_status(self) -> Dict[str, Any]:
        ...
        active_consents = sum(1 for c in self.consent_records.values() if not c.withdrawal_timestamp)
    ...
    def assess_sfg_compliance(self, compliance_id: str, assessment_data: Dict[str, Any]) -> bool:
        ...
        logger.info(f"Assessed SFG compliance {compliance_id}: {compliance.compliance_status}")
        return True
    ...
    def get_sfg_compliance_status(self) -> Dict[str, Any]:
        ...
        compliant_requirements = sum(1 for c in self.sfg_compliance.values() 
                                   if c.compliance_status == "compliant")
        pending_reviews = sum(1 for c in self.sfg_compliance.values() 
        ...
        return {
            ...
            "next_review": min([c.next_review for c in self.sfg_compliance.values() if c.next_review], default=None)
        }
                ...
                "requirements": [
                    {
                        ...
                        "last_reviewed": compliance.last_reviewed.isoformat() if compliance.last_reviewed else None,
                        "next_review": compliance.next_review.isoformat() if compliance.next_review else None
                    }
                    for compliance in self.sfg_compliance.values()
                ]
            }
    ...
    async def _check_overdue_assessments(self):
        ...
        if overdue_controls:
            logger.warning(f"Found {len(overdue_controls)} overdue SOC 2 assessments: {overdue_controls}")
    ...
    async def _check_upcoming_reviews(self):
        ...
        for compliance in self.sfg_compliance.values():
            if compliance.next_review and compliance.next_review < now + timedelta(days=7):
                upcoming_reviews.append(f"SFG: {compliance.compliance_id}")
        
        if upcoming_reviews:
            logger.info(f"Found {len(upcoming_reviews)} upcoming compliance reviews: {upcoming_reviews}")
