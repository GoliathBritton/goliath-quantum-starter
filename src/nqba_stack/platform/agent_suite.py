...
class AgentSuite:
    ...
    async def process_partner_revenue(self, partner_id: str, revenue: float) -> Dict[str, Any]:
    ...
    def get_partner_analytics(self, partner_id: str) -> Dict[str, Any]:
        ...
        return {
            "partner_info": {
                ...
                "white_label": partner["config"].white_label_type.value if partner["config"].white_label_type else None,
            ...
            "revenue_metrics": {
                ...
                "net_partner_revenue": partner["revenue"] - partner["service_fees_paid"],
    ...
    def get_platform_analytics(self) -> Dict[str, Any]:
        ...
        return {
            "platform_overview": {
                ...
                "white_label_deployments": self.revenue_tracking["white_label_deployments"],
