...
from ..auth import (
    AuthManager, User, UserCreate, UserUpdate, LoginRequest, 
    LoginResponse, PasswordChangeRequest, TwoFactorSetup
)
...
async def change_password(
    ...
    try:
        ...
        is_valid, validation_message = auth_manager.password_manager.validate_password_strength(
