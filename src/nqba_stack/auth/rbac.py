    ...
    def _initialize_system_roles(self):
        ...
        executive_role = Role(
            ...
            permissions=[
                perm.id
                for perm in system_permissions
                if perm.category != PermissionCategory.SYSTEM
            ],
            is_system_role=True,
        )
        ...
        architect_role = Role(
            ...
            permissions=[
                ...
                in [
                    ...
                    PermissionCategory.ECOSYSTEM,
                    PermissionCategory.QUANTUM,
                ]
            ],
            is_system_role=True,
        )
        ...
        manager_role = Role(
            ...
            permissions=[
                ...
                for perm in system_permissions
                if perm.category
                in [PermissionCategory.BUSINESS, PermissionCategory.DATA]
            ],
            is_system_role=True,
        )
