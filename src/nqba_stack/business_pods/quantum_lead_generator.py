...
INDUSTRIES = ["Energy", "Finance", "Manufacturing", "Healthcare", "Retail", "Logistics", "AI/ML", "Quantum Computing"]
BUDGETS = ["very high", "high", "medium", "low"]
URGENCIES = ["very urgent", "urgent", "normal", "low"]
PAIN_POINTS = [
    "energy costs", "production delays", "compliance risk", "supply chain", "AI adoption", "quantum readiness", "market volatility"
]
...
if __name__ == "__main__":
    ...
    print("Generated 100 best-in-class quantum buyer intent leads: quantum_buyer_intent_leads.csv")
